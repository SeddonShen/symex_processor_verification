...
namespace rv32 {
    constexpr uint32_t M_MIE_MASK = 0b100010001000;
    constexpr uint32_t M_MIP_MASK = 0b100010001000;
    constexpr uint32_t M_MIP_WRITE_MASK = 0b000000001000;
    constexpr uint32_t M_MTVEC_MASK = ~0b10;
    constexpr uint32_t M_MSTATUS_MASK = 0b1100010001000;
    constexpr uint32_t M_MCAUSE_MASK = (1 << 31) | 0b1111;
} // namespace rv32
